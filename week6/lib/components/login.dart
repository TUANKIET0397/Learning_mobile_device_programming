...
//                   // 1 Đặt nút đầu tiên để gọi phương thức login() và hiển thị bất kỳ thông báo lỗi nào.
//                   onPressed: () async {
...
//                       );
//                       // 2 Nếu có thông báo lỗi, trước tiên hãy kiểm tra xem đối tượng state có còn “gắn kết” (vẫn hiển thị) không, sau đó hiển thị một snackbar.
